...
export const routeComponent = {
  system_menus: {
    path: '/sys/page',
    component: () => import('@/views/sys/page/index.vue')
  },
  system_roles: {
    path: '/sys/roles',
  ...
  system_auths: {
    path: '/sys/auths',
    component: () => import('@/views/sys/auths/index.vue')
  },
  system_roleAuths: {
    path: '/sys/roleAuths/:id/:name',
    component: () => import('@/views/sys/roleAuths/index.vue')
  },
  system_users: {
    path: '/sys/users',
